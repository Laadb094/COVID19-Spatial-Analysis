...
- Publishes an interactive Leaflet map with togglable layers for observed rates, key determinants, and a composite vulnerability index.
...
- COVID DETERMINANTS IN ARC.xlsx — socioeconomic determinants table
...
- Overlays:
  - **COVID-19 cumulative rate** (default view).
...
- Popups: neighbourhood name, observed rate, determinants, vulnerability index.
- Controls: layer toggle (legends follow active layers), reset button, minimap, scale bar; polygons smoothed for cleaner rendering.
